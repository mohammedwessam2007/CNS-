...
(function () {
  ...
  (function () {
    ...
    A.scene("pain", {
      ...
      parts: {
        noc: ["Nociceptors (free nerve endings)", "Not encapsulated. Most numerous in the **skin** (also periosteum, arterial walls, joints, the dura); sparse in the viscera; **absent in brain tissue**. They signal damage without being destroyed, and cannot be switched off voluntarily. **Little or no adaptation** (they may even sensitize): the warning lasts as long as the damage. **More easily stimulated in injured tissue**."],
        bk: ["Bradykinin", "The **most painful** chemical released by damaged tissue (with K⁺, H⁺, histamine and serotonin; newer texts add **ATP** from broken cells, but the bank's answer is bradykinin)."],
        ...
        hyp1: ["Primary hyperalgesia", "In the **injured skin itself** (e.g. **sunburn**): inflammatory mediators (bradykinin, prostaglandins, histamine) **lower** the pain threshold. Pain sensibility is **increased**, and the skin is inflamed, not normal."],
  ...
  (function () {
    ...
    A.scene("visc", {
      ...
      parts: {
        ...
        tent: ["Tentorium cerebelli", "Pain-sensitive; pressure on it causes headache. It roofs the **posterior cranial fossa**, which holds the cerebellum, and separates the cerebellum from the occipital lobes."],
  ...
  (function () {
    ...
    A.scene("psp", {
      ...
      parts: {
        ...
        ipsp: ["IPSP", "A **hyperpolarization** that moves the potential **away from threshold**. IPSPs can summate too. Its duration is about the same as an EPSP's (~15 ms)."],
        ...
        rec: ["The receptor decides", "Whether a transmitter excites or inhibits depends on the **function of its postsynaptic receptor**, not the molecule. The molecule's composition does not decide it: ACh excites skeletal muscle (nicotinic) but slows the heart (M2)."],
        pinh: ["Presynaptic inhibition", "A **third (inhibitory) neuron** releases **GABA** onto **GABA receptors in the presynaptic terminal** → fewer Ca²⁺ channels open → **less transmitter released**. The postsynaptic membrane is not hyperpolarized. Ca²⁺ influx into the terminal **falls**; postsynaptic Ca²⁺ is not the mechanism."],
  ...
  (function () {
    ...
    A.scene("synprop", {
      ...
      parts: {
        ...
        fatigue: ["Synaptic fatigue", "With repetitive stimulation the store runs out: an **imbalance between the rates of synthesis and release**. It limits the spread of epileptic fits. Synthesis goes on; it simply cannot keep pace with release."],
        ...
        mict: ["Micturition reflex", "Shaped by bladder-wall stretch receptors, facilitatory and inhibitory **brainstem** centres, and **voluntary control from the cortex**; there is no voluntary control from the brainstem. Brainstem signals only shape the reflex; voluntary start and stop come from the cortex."],
      },
      al: {
