...
(function () {
  ...
  sessions.push({
    ...
    steps: [
      ...
      { id: "e2", type: "scene", stage: "reveal", min: 3, src: ["euler1736", "q.euler", "hierholzer"], terms: ["graph", "degree", "euler"], title: "Throw the map away", body: "Euler kept only what mattered: each land area became a dot, each bridge a line. Distances, shapes and streets vanished. What is left is a [[graph|graph]].\n\nNow count the lines at each dot, its [[degree|degree]]: the island has 5, the others 3, 3 and 3. A walk that passes through a dot uses two of its lines each time. So a walk using every line once ([[euler|an Euler path]]) can have odd dots only at its two ends. Königsberg has four odd dots. **No such walk exists.**", reps: [{ kind: "diagram", label: "Four dots, seven lines", svg: "graph4", body: "The whole city, as Euler saw it." }, { kind: "story", label: "In Euler's words", body: "He wrote to the mathematician Giovanni Marinoni in 1736: “This question is so banal, but seemed to me worthy of attention in that neither geometry, nor algebra, nor even the art of counting was sufficient to solve it.” He had seen that it belonged to a new mathematics of position." }, { kind: "counterexample", label: "What Euler did not prove", body: "Euler proved that odd dots rule a walk out. That two or zero odd dots always allow one was proved only in 1873, by Carl Hierholzer, after his death." }] },
