  ...
  (function () {
    ...
    A.scene("eyeball", {
      ...
      al: {
        ...
        cor: ["cornea", "corneal", "refracting surface", "43 d", "focusing power"],
        ...
        cepi: ["corneal epithelium", "non keratinized stratified squamous", "microvilli", "basal cells of the corneal epithelium"],
  ...
  (function () {
    ...
    A.scene("refract", {
      ...
      al: {
        ...
        hyp: ["hypermetropia", "hypermetropic", "hyperopia", "long sight", "convex lens", "shorter than the emmetropic", "range of accommodation"],
        ...
        miosis: ["miosis", "depth of focus", "chromatic aberration", "spherical aberration"],
        cat: ["cataract", "lens opacity", "loss of lens transparency", "denaturation", "coagulation of the proteins"],
      },
