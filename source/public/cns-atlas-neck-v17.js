  ...
  (function () {
    ...
    A.scene("levels", {
      ...
      al: {
        ...
        asa2: ["anterior spinal artery", "anterior 2 3 of the cord", "anterior two thirds of the cord", "anterior 2 3 of the spinal cord"],
  ...
  (function () {
    ...
    A.scene("necktri", {
      ...
      parts: {
        ...
        scm: ["Sternocleidomastoid (sternomastoid)", "Divides the neck into the anterior and posterior triangles; its posterior border bounds the posterior triangle in front. One muscle **turns the face to the opposite side** (and tilts the head to its own side); both together flex the neck. Inserted into the **mastoid process** and the superior nuchal line; the external jugular vein runs down on its superficial surface."],
  ...
  (function () {
    ...
    A.scene("eca", {
      ...
      parts: {
        ...
        ica: ["Internal carotid artery", "Gives **no branches in the neck**. Inside the skull its first big branch, the **ophthalmic** artery, supplies the orbit (not the submandibular gland: that is the facial artery)."],
