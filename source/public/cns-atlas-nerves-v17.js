  ...
  (function () {
    ...
    A.scene("trigem", {
      ...
      parts: {
        ...
        nasph: ["Nasal, pharyngeal and orbital branches", "Other branches of the ganglion. The **pharyngeal nerve** supplies the mucosa of the **nasopharynx**; it does not reach the larynx."],
      ...
      al: {
        ...
        lin: ["lingual nerve", "anterior 2 3 of the tongue", "anterior 2 3 of tongue", "anterior part of tongue", "tip of the tongue", "~5th"],
        ct3: ["chorda tympani", "chorda tympani nerve", "taste sensation from anterior 2 3", "taste sensations to anterior 2 3", "~7th"],
