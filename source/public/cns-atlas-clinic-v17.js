  ...
  (function () {
    ...
    A.scene("umnlmn", {
      ...
      parts: {
        ...
        l_sup: ["Denervation supersensitivity (LMN)", "Due to an **increased number of ACh receptors** spread over the denervated fibre, **not** fewer receptors. This is the muscle's sensitivity to ACh, not **hyperaesthesia**: skin sensation is not heightened in an LMN lesion."],
        ...
        nb_sleep: ["Sleep", "**Lowers** tone and reflexes. So sleep never shows hypertonia or hyperreflexia."],
